...
import com.capitalone.AccountServiceProducer.Deserializer.ConsumerAvoraDeserializer;
...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, Customer> consumerFactory() {
		...
		props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ConsumerAvoraDeserializer.class);
